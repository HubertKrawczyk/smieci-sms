...
import "smieci-sms/internal/commands"
...
const (
	Welcome = "Witaj! \n\n" +
		...
		"Wpisz " + commands.Prywatnosc + ", aby przeczytać Politykę Prywatności.\n\n" +
		"Jeśli chcesz całkowicie usunąć swoje dane, w dowolnym momencie wpisz " + commands.Usun + ". \n\n" +
	...
	RegistrationCanceled         = "Rejestracja została anulowana. Wpisz " + commands.Start + ", aby spróbować ponownie."
	SomethingWentWrong           = "Przepraszamy, coś poszło nie tak. Wpisz " + commands.Start + ", aby rozpocząć proces rejestracji od nowa."
	UnknownCommand               = "Nie rozumiem tej komendy lub wiadomości. Dostępne komendy:\n" + commands.Start + " - Rozpocznij rejestrację\n" + commands.Harmonogram + " - Sprawdź najbliższe wywozy\n" + commands.EdytujPowiadomienia + " - Edytuj preferencje powiadomień\n" + commands.Prywatnosc + " - Polityka prywatności\n" + commands.Usun + " - Usuń swoje dane"
	...
	SaveError                    = "Coś poszło nie tak podczas zapisywania Twojej lokalizacji i preferencji. Wpisz " + commands.Start + ", aby spróbować ponownie."
	ConfirmationWithPreferences  = "Wybór lokalizacji potwierdzony (%s)! Rejestracja przebiegła pomyślnie. Będziesz otrzymywać powiadomienia o godzinach: %s.\n\nTwój harmonogram wywozu będzie odświeżany automatycznie z serwerów miasta co 3 dni.\n\nDostępne komendy:\n" + commands.Harmonogram + " - Sprawdź wywozy\n" + commands.EdytujPowiadomienia + " - Edytuj powiadomienia\n" + commands.Usun + " - Usuń dane\n" + commands.Start + " - Rejestracja od nowa"
